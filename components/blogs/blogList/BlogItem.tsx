...
const BlogItem: FunctionComponent<Props> = ({ blog }) => {
  ...
  return (
    <Link
      ...
      className="mb-20 flex max-h-96 w-full cursor-pointer flex-col md:max-h-[484px] md:w-[355px] xl:w-[400px] 4xl:min-h-[484px] 4xl:w-[445px]"
    >
      ...
      <div className="w-full">
        ...
        <h3 className="mb-2 h-[54px] w-full text-lg font-bold leading-normal text-[#292929] line-clamp-2">
          {blog.title}
        </h3>
